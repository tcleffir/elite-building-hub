...
export const VILG11_ASSET_IDS = ['b2', 'b3', 'b4', 'b5', 'b6', 'b7', 'b8', 'b9', 'b10', 'b11', 'b12'] as const;
export type VILG11AssetId = typeof VILG11_ASSET_IDS[number];
export const isVILG11Asset = (buildingId?: string | null): buildingId is VILG11AssetId =>
  !!buildingId && (VILG11_ASSET_IDS as readonly string[]).includes(buildingId);
...
export const mockBuildings: Building[] = [
  ...
  {
    id: 'b2', name: 'Alianza Park', short_name: 'Alianza Park',
    address: 'Rod. Anhanguera, km 33 — Cajamar, SP', city: 'Cajamar', state: 'SP',
    total_floors: 1, total_area_m2: 85000, certification_leed_level: '', occupancy_rate: 95,
    administrator_company: 'Administradora', status: 'active', urgent_tickets: 0,
    segment: 'logistics', fund_name: 'VILG11 — Vinci Logística', gla_m2: 85000, occupancy_pct: 95,
    monthly_revenue: 1850000, monthly_noi: 1620000, cap_rate_target: 8.20, wault_months: 38,
    next_expiry_date: '2027-08-01', esg_score: 74, portfolio_status: 'healthy',
    full_address: 'Rod. Anhanguera, km 33 — Cajamar, SP',
  },
  {
    id: 'b3', name: 'Extrema Business Park I', short_name: 'Extrema BP I',
    address: 'Rod. Fernão Dias, km 935 — Extrema, MG', city: 'Extrema', state: 'MG',
    total_floors: 1, total_area_m2: 62000, certification_leed_level: '', occupancy_rate: 100,
    administrator_company: 'Administradora', status: 'active', urgent_tickets: 0,
    segment: 'logistics', fund_name: 'VILG11 — Vinci Logística', gla_m2: 62000, occupancy_pct: 100,
    monthly_revenue: 1420000, monthly_noi: 1250000, cap_rate_target: 8.50, wault_months: 44,
    next_expiry_date: '2028-02-01', esg_score: 78, portfolio_status: 'healthy',
    full_address: 'Rod. Fernão Dias, km 935 — Extrema, MG',
  },
  {
    id: 'b4', name: 'BTS Cremer', short_name: 'BTS Cremer',
    address: 'Rod. BR-381, km 12 — Pouso Alegre, MG', city: 'Pouso Alegre', state: 'MG',
    total_floors: 1, total_area_m2: 38000, certification_leed_level: '', occupancy_rate: 100,
    administrator_company: 'Administradora', status: 'active', urgent_tickets: 0,
    segment: 'logistics', fund_name: 'VILG11 — Vinci Logística', gla_m2: 38000, occupancy_pct: 100,
    monthly_revenue: 780000, monthly_noi: 695000, cap_rate_target: 8.80, wault_months: 84,
    next_expiry_date: '2032-12-01', esg_score: 70, portfolio_status: 'healthy',
    full_address: 'Rod. BR-381, km 12 — Pouso Alegre, MG',
  },
  {
    id: 'b5', name: 'Airport Town Ayrton Senna', short_name: 'Airport Town AS',
    address: 'Rod. Ayrton Senna, km 18 — Guarulhos, SP', city: 'Guarulhos', state: 'SP',
    total_floors: 1, total_area_m2: 54000, certification_leed_level: '', occupancy_rate: 92,
    administrator_company: 'Administradora', status: 'active', urgent_tickets: 0,
    segment: 'logistics', fund_name: 'VILG11 — Vinci Logística', gla_m2: 54000, occupancy_pct: 92,
    monthly_revenue: 1180000, monthly_noi: 1010000, cap_rate_target: 8.10, wault_months: 32,
    next_expiry_date: '2027-04-01', esg_score: 72, portfolio_status: 'healthy',
    full_address: 'Rod. Ayrton Senna, km 18 — Guarulhos, SP',
  },
  {
    id: 'b6', name: 'Castelo 57 Business Park', short_name: 'Castelo 57',
    address: 'Rod. Castello Branco, km 57 — Itu, SP', city: 'Itu', state: 'SP',
    total_floors: 1, total_area_m2: 47000, certification_leed_level: '', occupancy_rate: 88,
    administrator_company: 'Administradora', status: 'active', urgent_tickets: 0,
    segment: 'logistics', fund_name: 'VILG11 — Vinci Logística', gla_m2: 47000, occupancy_pct: 88,
    monthly_revenue: 980000, monthly_noi: 832000, cap_rate_target: 8.30, wault_months: 26,
    next_expiry_date: '2026-09-01', esg_score: 68, portfolio_status: 'attention',
    full_address: 'Rod. Castello Branco, km 57 — Itu, SP',
  },
  {
    id: 'b7', name: 'Airport Town Guarulhos III', short_name: 'Airport Town GRU III',
    address: 'Av. Monteiro Lobato, 5500 — Guarulhos, SP', city: 'Guarulhos', state: 'SP',
    total_floors: 1, total_area_m2: 41000, certification_leed_level: '', occupancy_rate: 78,
    administrator_company: 'Administradora', status: 'active', urgent_tickets: 0,
    segment: 'logistics', fund_name: 'VILG11 — Vinci Logística', gla_m2: 41000, occupancy_pct: 78,
    monthly_revenue: 820000, monthly_noi: 690000, cap_rate_target: 7.90, wault_months: 18,
    next_expiry_date: '2026-03-01', esg_score: 65, portfolio_status: 'critical',
    full_address: 'Av. Monteiro Lobato, 5500 — Guarulhos, SP',
  },
  {
    id: 'b8', name: 'CD Cariacica', short_name: 'CD Cariacica',
    address: 'Rod. BR-262, km 8 — Cariacica, ES', city: 'Cariacica', state: 'ES',
    total_floors: 1, total_area_m2: 33000, certification_leed_level: '', occupancy_rate: 100,
    administrator_company: 'Administradora', status: 'active', urgent_tickets: 0,
    segment: 'logistics', fund_name: 'VILG11 — Vinci Logística', gla_m2: 33000, occupancy_pct: 100,
    monthly_revenue: 690000, monthly_noi: 612000, cap_rate_target: 9.00, wault_months: 60,
    next_expiry_date: '2030-05-01', esg_score: 66, portfolio_status: 'healthy',
    full_address: 'Rod. BR-262, km 8 — Cariacica, ES',
    lux_client: true,
  },
  {
    id: 'b9', name: 'CD Eldorado', short_name: 'CD Eldorado',
    address: 'Rod. PA-150, km 14 — Eldorado dos Carajás, PA', city: 'Eldorado dos Carajás', state: 'PA',
    total_floors: 1, total_area_m2: 29000, certification_leed_level: '', occupancy_rate: 100,
    administrator_company: 'Administradora', status: 'active', urgent_tickets: 0,
    segment: 'logistics', fund_name: 'VILG11 — Vinci Logística', gla_m2: 29000, occupancy_pct: 100,
    monthly_revenue: 560000, monthly_noi: 498000, cap_rate_target: 9.20, wault_months: 72,
    next_expiry_date: '2031-09-01', esg_score: 64, portfolio_status: 'healthy',
    full_address: 'Rod. PA-150, km 14 — Eldorado dos Carajás, PA',
  },
  {
    id: 'b10', name: 'CD Cachoeirinha', short_name: 'CD Cachoeirinha',
    address: 'Rod. BR-290, km 12 — Cachoeirinha, RS', city: 'Cachoeirinha', state: 'RS',
    total_floors: 1, total_area_m2: 36000, certification_leed_level: '', occupancy_rate: 94,
    administrator_company: 'Administradora', status: 'active', urgent_tickets: 0,
    segment: 'logistics', fund_name: 'VILG11 — Vinci Logística', gla_m2: 36000, occupancy_pct: 94,
    monthly_revenue: 720000, monthly_noi: 631000, cap_rate_target: 8.60, wault_months: 40,
    next_expiry_date: '2027-11-01', esg_score: 71, portfolio_status: 'healthy',
    full_address: 'Rod. BR-290, km 12 — Cachoeirinha, RS',
  },
  {
    id: 'b11', name: 'Parque Logístico Pernambuco', short_name: 'PL Pernambuco',
    address: 'Rod. BR-101, km 80 — Cabo de Sto. Agostinho, PE', city: 'Cabo de Santo Agostinho', state: 'PE',
    total_floors: 1, total_area_m2: 44000, certification_leed_level: '', occupancy_rate: 90,
    administrator_company: 'Administradora', status: 'active', urgent_tickets: 0,
    segment: 'logistics', fund_name: 'VILG11 — Vinci Logística', gla_m2: 44000, occupancy_pct: 90,
    monthly_revenue: 880000, monthly_noi: 760000, cap_rate_target: 8.70, wault_months: 36,
    next_expiry_date: '2027-06-01', esg_score: 69, portfolio_status: 'healthy',
    full_address: 'Rod. BR-101, km 80 — Cabo de Santo Agostinho, PE',
  },
  {
    id: 'b12', name: 'Caxias Park', short_name: 'Caxias Park',
    address: 'Rod. Washington Luís, km 110 — Duque de Caxias, RJ', city: 'Duque de Caxias', state: 'RJ',
    total_floors: 1, total_area_m2: 51000, certification_leed_level: '', occupancy_rate: 96,
    administrator_company: 'Administradora', status: 'active', urgent_tickets: 0,
    segment: 'logistics', fund_name: 'VILG11 — Vinci Logística', gla_m2: 51000, occupancy_pct: 96,
    monthly_revenue: 1120000, monthly_noi: 980000, cap_rate_target: 8.00, wault_months: 30,
    next_expiry_date: '2027-01-01', esg_score: 73, portfolio_status: 'healthy',
    full_address: 'Rod. Washington Luís, km 110 — Duque de Caxias, RJ',
  },
];

export const getVILG11PortfolioBuildings = () => mockBuildings.filter((b) => isVILG11Asset(b.id));

// ─── Tenant Contracts seed data ──────────────────────
// Caxias Park (b12) — VILG11 portfolio: 8 locatários logísticos
export const mockTenantContracts: TenantContract[] = [
  { id: 'tc1', building_id: 'b12', unit_id: 'Galpão A1', tenant_name: 'Magazine Luiza', tenant_cnpj: '11.260.134/0001-50', area_m2: 7500, price_per_m2: 24, contract_type: 'net', contract_start: '2022-03-01', contract_end: '2027-02-28', status: 'active', lease_nature: 'tipico', tenant_segment: 'Varejo' },
  { id: 'tc2', building_id: 'b12', unit_id: 'Galpão A2', tenant_name: 'Ambev S.A.', tenant_cnpj: '07.526.557/0001-00', area_m2: 9000, price_per_m2: 23, contract_type: 'net', contract_start: '2021-08-01', contract_end: '2026-07-31', status: 'active', lease_nature: 'atipico', tenant_segment: 'Bebidas' },
  { id: 'tc3', building_id: 'b12', unit_id: 'Galpão B1', tenant_name: 'Solistica (Grupo FEMSA)', tenant_cnpj: '13.453.928/0001-77', area_m2: 6500, price_per_m2: 25, contract_type: 'net', contract_start: '2023-01-01', contract_end: '2028-12-31', status: 'active', lease_nature: 'atipico', tenant_segment: 'Logística 3PL' },
  { id: 'tc4', building_id: 'b12', unit_id: 'Galpão B2', tenant_name: 'Tok&Stok', tenant_cnpj: '54.137.319/0001-03', area_m2: 5800, price_per_m2: 22, contract_type: 'gross', contract_start: '2022-11-01', contract_end: '2026-10-31', status: 'active', lease_nature: 'tipico', tenant_segment: 'Varejo' },
  { id: 'tc5', building_id: 'b12', unit_id: 'Galpão C1', tenant_name: 'Supporte', tenant_cnpj: '04.870.532/0001-66', area_m2: 4200, price_per_m2: 21, contract_type: 'semi-gross', contract_start: '2024-02-01', contract_end: '2027-01-31', status: 'active', lease_nature: 'tipico', tenant_segment: 'Serviços' },
  { id: 'tc6', building_id: 'b12', unit_id: 'Galpão C2', tenant_name: 'DHL', tenant_cnpj: '03.420.926/0001-08', area_m2: 7800, price_per_m2: 26, contract_type: 'net', contract_start: '2023-06-01', contract_end: '2028-05-31', status: 'active', lease_nature: 'atipico', tenant_segment: 'Logística 3PL' },
  { id: 'tc7', building_id: 'b12', unit_id: 'Galpão D1', tenant_name: 'Sierra Log', tenant_cnpj: '08.913.572/0001-19', area_m2: 4500, price_per_m2: 23, contract_type: 'gross', contract_start: '2024-04-01', contract_end: '2027-03-31', status: 'active', lease_nature: 'tipico', tenant_segment: 'Logística 3PL' },
  { id: 'tc8', building_id: 'b12', unit_id: 'Galpão D2', tenant_name: 'Caedu', tenant_cnpj: '05.629.244/0001-50', area_m2: 3660, price_per_m2: 22, contract_type: 'net', contract_start: '2023-09-01', contract_end: '2026-08-31', status: 'active', lease_nature: 'tipico', tenant_segment: 'Vestuário' },

  { id: 'tc9', building_id: 'b12', unit_id: 'Galpão D3', tenant_name: null, area_m2: 2040, price_per_m2: null, contract_type: null, status: 'vacant' },
];
...
export const mockPortfolioBudgets: PortfolioBudget[] = [
  { building_name: 'Alianza Park', month: 3, year: 2026, budgeted_revenue: 1880000, realized_revenue: 1850000 },
  { building_name: 'Extrema Business Park I', month: 3, year: 2026, budgeted_revenue: 1450000, realized_revenue: 1420000 },
  { building_name: 'BTS Cremer', month: 3, year: 2026, budgeted_revenue: 800000, realized_revenue: 780000 },
  { building_name: 'Airport Town Ayrton Senna', month: 3, year: 2026, budgeted_revenue: 1200000, realized_revenue: 1180000 },
  { building_name: 'Castelo 57 Business Park', month: 3, year: 2026, budgeted_revenue: 1000000, realized_revenue: 980000 },
  { building_name: 'Airport Town Guarulhos III', month: 3, year: 2026, budgeted_revenue: 840000, realized_revenue: 820000 },
  { building_name: 'CD Cariacica', month: 3, year: 2026, budgeted_revenue: 700000, realized_revenue: 690000 },
  { building_name: 'CD Eldorado', month: 3, year: 2026, budgeted_revenue: 575000, realized_revenue: 560000 },
  { building_name: 'CD Cachoeirinha', month: 3, year: 2026, budgeted_revenue: 735000, realized_revenue: 720000 },
  { building_name: 'Parque Logístico Pernambuco', month: 3, year: 2026, budgeted_revenue: 900000, realized_revenue: 880000 },
  { building_name: 'Caxias Park', month: 3, year: 2026, budgeted_revenue: 1140000, realized_revenue: 1120000 },
];
...
export const mockTickets: Ticket[] = [
  ...
  // Airport Town Guarulhos III (b7) tickets
  {
    ...
    requester: 'Sierra Log', floor: 3, building_id: 'b7',
    created_at: '2026-03-10T09:00:00', sla_deadline: '2026-03-12T09:00:00',
    comments_count: 0, attachments_count: 1, timeline: [
      { id: 'e19', type: 'created', description: 'Chamado aberto por Sierra Log', author: 'Sierra Log — Administrador', created_at: '2026-03-10T09:00:00' },
    ]
  },
  {
    id: 'CH-012', title: 'Portão de doca intermitente — Airport Town GRU III',
    description: 'Portão de doca do Airport Town Guarulhos III parou de funcionar duas vezes hoje.',
    ...
    comments_count: 3, attachments_count: 0, timeline: [
      { id: 'e20', type: 'created', description: 'Chamado aberto pela Administração', author: 'Administração Airport Town GRU III', created_at: '2026-03-09T07:30:00' },
      { id: 'e21', type: 'assigned', description: 'Atribuído a TechElev', author: 'Administração', created_at: '2026-03-09T08:00:00' },
    ]
  },
  // CD Cariacica (b8) tickets
  {
...
export const mockAnnouncements: Announcement[] = [
  ...
  },
  {
    ...
    content: 'O contrato de locação da DHL (Galpão C2) vence em 30/06/2026. A gestão já iniciou o processo de renovação.',
  ...
  {
    id: 'a5', title: '🌱 CD Cariacica obtém certificação LEED Gold',
    content: 'O CD Cariacica obteve a certificação LEED Gold. Agradecemos o empenho de todos os ocupantes nas práticas sustentáveis.',
  ...
  },
  {
    ...
    read: false, author: { name: 'Administração', company: 'Airport Town Guarulhos III', position: 'Gerente de Ativos' },
  ...
  },
  {
    ...
    content: 'O relatório ESG do primeiro trimestre de 2026 do CD Cariacica está disponível para consulta e download na área de documentos.',
  ...
  {
    id: 'a8', title: '🏗️ Obra no pátio — Airport Town GRU III',
    content: 'A reforma do pátio do Airport Town Guarulhos III será realizada entre 01/04 e 15/04/2026. O acesso será pelo portão lateral.',
    category: 'Administrativo', priority: 'normal', published_at: '2026-03-02T09:00:00',
    read: true, author: { name: 'Administração', company: 'Airport Town Guarulhos III', position: 'Gerente de Ativos' },
...
export const mockNexusSolutions: NexusSolution[] = [
  ...
  { id: 'n7', slug: 'certificacoes-esg', name: 'Certificações Sustentáveis / ESG', icon: '🌱', badge: 'Expertise Vinci Compass', description: 'Assessoria completa para obtenção e manutenção de certificações ESG para seu ativo.', tags: ['LEED', 'BREEAM', 'ISO 14001', 'GHG Protocol'], cta: 'Iniciar Processo' },
