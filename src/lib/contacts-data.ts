...
export const mockContacts: Contact[] = [
  ...
  { id: 'ct4', name: 'Adriana Bertolucci', email: 'adriana.bertolucci@capitaleenergia.com.br', phone: '(11) 99999-0004', type: 'tenant_admin', company: 'Capitale Energia', jobTitle: 'Locatário Admin', linkedUserId: '5', isActive: true, groupIds: ['g2', 'g6'], createdAt: '2026-01-10' },
