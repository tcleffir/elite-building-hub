...
export const mockAssets: Asset[] = [
  {
    ...
    description: "Sistema VRF de 22HP atendendo o 7º andar (Vivo (Telefônica Brasil)).",
...
export const mockAssetLogs: AssetChangeLog[] = [
  ...
  },
  {
    ...
    performedAt: "2025-09-04T11:42:00", userId: "1", userName: "Vivo (Telefônica Brasil) — Admin",
  ...
  },
  {
    ...
    performedAt: "2019-11-10T08:00:00", userId: "1", userName: "Vivo (Telefônica Brasil) — Admin",
    userRole: "Super Admin", source: "manual",
    summary: "Cadastrou o ativo (importação inicial)",
  },
  {
    id: "LOG-007", assetId: "AT-003", type: "attachment",
    performedAt: "2020-02-15T17:20:00", userId: "1", userName: "Vivo (Telefônica Brasil) — Admin",
    userRole: "Super Admin", source: "manual",
  ...
  },
  {
    ...
    performedAt: "2020-06-30T11:00:00", userId: "1", userName: "Vivo (Telefônica Brasil) — Admin",
    userRole: "Super Admin", source: "manual",
